...
export CUDA_VISIBLE_DEVICES=0,1,2,3 # fallback for local test
...
train_data=[$(pwd)/data/pixel_reasoner/LamRA_RL_Data/lamra_train_300K.parquet]
val_data=[$(pwd)/data/pixel_reasoner/LamRA_RL_Data/lamra_val_300K.parquet]
...
run_name_postfix="lamra_test1_gpu4_fsdpsize1"
