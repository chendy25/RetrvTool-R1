...
train_data=/home/zengyuqi/verl_tool_rag/gsm8k/train.parquet

val_data=[/home/zengyuqi/verl_tool_rag/gsm8k/test.parquet]

model_name=/home/zengyuqi/model/Qwen2.5-Math-1.5B
rl_alg=grpo 
n_gpus_per_node=4
n_nodes=1
n=16
